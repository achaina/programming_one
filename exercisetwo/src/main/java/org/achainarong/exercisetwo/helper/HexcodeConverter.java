...
public class HexcodeConverter {
    ...
    public static String ConvertStringToHex(String stringToConvert) {
        ...
        // Strings are immutable and are generated every time we would use the "+"
        // operator which impacts the memory usage.
        // StringBuilder is an mutable sequence of characters. It is used because we are
        // iterating over an array an appending an n amount of strings.
